...
// --- (useAutosave hook - same as your correct version) ---
...
export default function EditTopicPage({ params }) {
    ...
    //  الخطوة 2: تحديث دالة الحفظ التلقائي
    const handleAutoSave = useCallback(async (dataToSave) => {
        ...
        try {
            ...
            //  التحديث هنا: نضيف 'updatedAt'
            await updateDoc(docRef, { 
                ...dataToSave, 
                content: contentToSave, 
                tags: tagSlugs, 
                updatedAt: serverTimestamp() //  <--  الإضافة الجديدة
            });
    ...
    // --- (Initial Data Fetching - same as your correct version) ---
    ...
    // --- (Block management functions - same as your correct version) ---
